...
interface Gamedatas<P = Player> {
  player_board_side: boolean;
  canceledNotifIds: any;
  bonus_actions: any;
  travel_supply: any;
  hand: any;
  end_bonus: any;
...
declare class GameGui<G = Gamedatas> {
   ...
   *  1Â°) mobile_obj has a position:absolute or position:relative
   *  2Â°) a fixed mobile_obj parent has a position absolute or relative
   */
